...
# Job name
#SBATCH --job-name=SIESTA-MoS2-Monolayer-GGA-T-rectangular-1x10-4%
...
BandsCond=T
LDOSCond=T
homedir="${QMATSIM_WORKSPACE_ROOT:?Set QMATSIM_WORKSPACE_ROOT}/siesta/materials/MoS2/Monolayer/rectangular/1x10/4/"

if [ "$SOCCond" = "T" ]; then
    scratchFolder="${QMATSIM_SCRATCH_ROOT:?Set QMATSIM_SCRATCH_ROOT}/MoS2/Monolayer/GGA-SOC/rectangular/1x10/4/"
    potdir="${QMATSIM_PSEUDOPOTENTIAL_ROOT:?Set QMATSIM_PSEUDOPOTENTIAL_ROOT}/GGA-SOC/"
else
    scratchFolder="${QMATSIM_SCRATCH_ROOT:?Set QMATSIM_SCRATCH_ROOT}/MoS2/Monolayer/GGA/rectangular/1x10/4/"
